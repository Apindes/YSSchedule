...
const staticResources = ["app/fonts/**/*","app/css/**/*.css","app/**/*.json","app/media/**/*"];
...
lazyRequireTask("watch", "./tasks/watch", {"src": "app/**/*", "tasks": ["copy", "compile:styles", "compile:scripts", "minimize:html", "minimize:images"]});
lazyRequireTask("reload", "./tasks/reload", {destination}, ["build"]);

gulp.task("build:watch", ["build", "watch"]);
gulp.task("build", ["minimize:html", "compile:styles", "compile:scripts", "minimize:images", "copy"]);